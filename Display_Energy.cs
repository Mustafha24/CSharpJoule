...
{
    public class Display_Energy
    {
        private Measure_Energy measure_Energy;
        private string outputFile = "CJoules_output.csv";

        public Display_Energy()
        {
            measure_Energy = new Measure_Energy();
        ...
        {
            var traceStart = measure_Energy.GetEnergyTrace();
            ...
            var traceEnd = measure_Energy.GetEnergyTrace();
